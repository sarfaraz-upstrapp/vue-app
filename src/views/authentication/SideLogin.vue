...
<template>
  <div class="pa-3">
    <v-row class="h-100vh mh-100 auth justify-center">
      <v-col
        cols="12"
        lg="7"
        xl="8"
      ...
      <v-col cols="12" sm="8" md="6" lg="5" xxl="3" class="d-flex align-center justify-center">
        <div class="mt-xl-0 mt-5 w-75">
          <h2 class="text-h3 font-weight-bold mb-2">Welcome On My App</h2>
